...
% Auto-generated by MATLAB on 28-Oct-2015 16:01:48
...
subspaceDimension = max(1, min(12, width(predictors) - 1));
classificationEnsemble = fitensemble(...
    ...
    'ClassNames', categorical({'RightFingerSpreadBue'; 'RightClosedBue'; 'RightRelaxedBue'}));
...
% Train a classifier
% This code specifies all the classifier options and trains the classifier.
subspaceDimension = max(1, min(12, width(trainingPredictors) - 1));
classificationEnsemble = fitensemble(...
    trainingPredictors, ...
    trainingResponse, ...
    'Subspace', ...
