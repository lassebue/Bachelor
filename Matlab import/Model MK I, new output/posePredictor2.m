...
if(subspaceKNN.ClassificationEnsemble.ClassNames(1) == predictedCats(1))
    abe = 0;
elseif(subspaceKNN.ClassificationEnsemble.ClassNames(2) == predictedCats(1))
    abe = 1;
elseif(subspaceKNN.ClassificationEnsemble.ClassNames(3) == predictedCats(1))
    abe = 2;
end
