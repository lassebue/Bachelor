...
\myFigure{CLConfusionMatrix}{Ved hver kolonnerne ses input 0, 1 og 2. Gives et pose med id 0 som input, vil der være 97,5\% chance for at outputtet er 0. Det ses, at der er 0,7\% risiko for at ouputtet bliver 1, og 1,9\% risiko for output 2. Der er testet med 914 inputs med id 0, hvoraf 891 giver det sande output. Hvorimod 6 inputs er fejlklassificeret til id 1 og 17 til id 2.}{fig:clcm}{0.6}

De trænede modeller kan eksporteres som klasser til et workspace, hvorefter de kan indgå og anvendes i MATLAB-funktion og scripts til klassifikation af EMG-vinduer.
