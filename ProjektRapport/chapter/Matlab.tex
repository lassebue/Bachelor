...
\myFigure{CLHistory}{Historie over de trænede modeller. Bagged Tree øverst, markeret med størst præcision på 99,1\%. Hvorimod Simple Tree f.eks. kun har en præcision på 71,2\%}{fig:CLHistory}{0.35}
