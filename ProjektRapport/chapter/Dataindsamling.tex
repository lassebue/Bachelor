...
\myFigure{sample2}{eks. fra en sekvens af samples, hvor informationerne der optages ses. Time er tiden der er gået siden starten af optagelsen. Emg1-8 er EMG signalerne fra de 8 sensorer lavet til en integer. Hand er hvilken hånd der er brugt. Pose er hvilken pose der opsamles data på.orientation er Myo'en orientering. testPerson, er den person er har opsamlet dataen. }{fig:sample}{1}

\todokr{skriv om at hand ikke bliver gemt i videre behandling at data, da vores krav siger at vi kun bruger højre hånd}
