...
\myFigure{sample2}{Eksempel fra en sekvens af samples, hvor informationerne, der optages, kan ses. time er tiden, der er gået siden starten af optagelsen. emg1-8 er EMG-signalerne fra de 8 sensorer lavet til en integer. hand er hånden der er brugt. pose er posen der opsamles data på. Dette er en PoseID, der kan variere fra 0 til 2. orientation er Myo'ens orientering. Denne går fra 0 til 49, og fortæller hvordan Myo'en sidder på armen. testPerson, er den person der har opsamlet dataene.}{fig:sample}{1}
