...
\myFigure{anatomy}{Underarm med markering af muskler. Det ses hvordan forskellige muskler hæfter forskelligt i håndledet, og dermed har hver sin funktion i hånden. Den grønne muskel kan være den der ved sammentrækning bøjer lillefingeren, mens den blå ved sammentrækning bøjer ringefingeren.}{fig:anatomy}{1}
