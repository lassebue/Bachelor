...
\myFigure{baggingtreepic}{På figuren ses et diagram over den generelle ensemble algoritme, som bagging ligeledes følger. På diagrammet ses et træningssæt, hvorfra tre subset genereres. Ud fra disse trænes tre classifers med en udvalgt learner. De tre trænede classifiers kombineres ved majority voting eller gennemsnit, hvis der anvendes bagging. Herefter vil der kunne klassificeres ny data, på den resulterende classifier.\citep{merebaggingPicRef}}{fig:baggingtree}{0.8}
