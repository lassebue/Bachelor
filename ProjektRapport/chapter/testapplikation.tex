...
\myFigure{MVVM}{Den implementerede arkitektur i applikationen. View'et er adskildt fra modellen med en ViewModel. Modellen er delt op i flere klasser for at opfylde SOLID\citep{RefWorks:10} pricipperne hvor det giver mening i applikationen}{fig:mvvm}{1}
